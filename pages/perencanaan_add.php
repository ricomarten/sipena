...
$cek_nama=mysqli_query($conn,"select nama from kegiatan where nama='".$_POST['nama']."'");
...
elseif($_POST['pc']>$data['pc']){
	...
	if($berhasil){	
		...
		$result=mysqli_query($conn,"INSERT INTO kegiatan(nama,jadwal_awal,jadwal_selesai,target_dokumen,waktu_olah,jam_kerja,hari_kerja,pc,prediksi,rekomendasi) 
